...
import static com.man4fun.game.rpc.core.common.cache.CommonClientCache.RESP_MAP;
...
public class ClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if(rpcInvocation.getUuid().equals("-1")){
            ClientReadNtfHandler.onClientReadNtf(rpcInvocation.getTargetMethod(), rpcInvocation.getResponse());
            return;
        }
